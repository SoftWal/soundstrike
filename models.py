...
def Conv1D(N_CLASSES=10, SR=16000, DT=1.0):
    ...
    melspec_layer = get_melspectrogram_layer(input_shape=input_shape,
                                             n_mels=128,
                                             pad_end=True,
                                             n_fft=512,
                                             win_length=400,
    ...
    x = layers.Dense(32, activation='relu', activity_regularizer=l2(0.001), name='dense')(x)
...
def LSTM(N_CLASSES=10, SR=16000, DT=1.0):
    ...
    x = layers.Dense(32, activation='relu', name='dense_1_relu')(x)
    x = layers.MaxPooling1D(name='max_pool_1d')(x)
    x = layers.Dense(16, activation='relu', name='dense_2_relu')(x)
    x = layers.Flatten(name='flatten')(x)
    x = layers.Dropout(rate=0.2, name='dropout')(x)
