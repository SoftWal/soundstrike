...
async def send_message(latitude, longitude):
    ...
    client_cert = os.path.expanduser("~/Cloud-Coms/SoundDetector_cert.pem")
    client_key = os.path.expanduser("~/Cloud-Coms/SoundDetector_key.pem")
    ca_cert = os.path.expanduser("~/Cloud-Coms/Cloud-ArgusTAK.pem")
