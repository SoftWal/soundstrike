...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_fn', type=str, default='audio_classifier/models/conv2d.keras', help='Model file to use for predictions.')
    parser.add_argument('--src_dir', type=str, default='audio_classifier/wavfiles', help='Directory containing class labels.')
    ...
    parser.add_argument('--threshold', type=int, default=80, help='Threshold magnitude for np.int16 dtype.')
